import { Home, MessageSquare, Building2 } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { icon: MessageSquare, label: "상담 관리", path: "/admin/consultations" },
  { icon: Building2, label: "프로필 관리", path: "/admin/profile" },
];
